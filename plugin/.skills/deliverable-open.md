...
Run `python3 $DTOOL/scripts/check_deliverable.py --root <dir>` once and show the result. Name the next step in one line: dictate the first braindump into `inbox/`, then `/oss:deliverable-intake`.
