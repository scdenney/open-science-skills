...
name: topic-modeling
description: Specifies and diagnoses structural topic models for survey and experimental text. Covers STM, LDA, and BERTopic choice, preprocessing consequences, prevalence and content formulas with spectral initialization and recorded seed, topic-count selection across semantic coherence, exclusivity and FREX, held-out likelihood, and residuals, interpretation and validation against representative documents, robustness checks, and DA-RT-compliant reporting. Use when the user has open-ended responses or another corpus and asks what topics are present, how many topics to use, about STM, searchK, coherence, or FREX, or wants topic prevalence compared across treatment arms or countries. Fixed-codebook coding goes to text-classification.
