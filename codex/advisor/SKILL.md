...
<p align="center"><img src="assets/architecture.svg" alt="Codex advisor: a working GPT-5.6 session sends a self-contained briefing to a Sol high advisor; the advisor returns one decisive read-only review" width="900"></p>
